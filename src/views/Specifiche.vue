  ...
  <ion-page>
    <ion-content>
      ...
      <div class="sub-container">
        ...
        <div class="box-select" v-for="tagType in tags" :key="tagType.tag_type_id">
          <ion-label class="choose-client"> {{tagType.tag_type_name}}: </ion-label>
          <ion-select class="my-select" v-model="selectedTags[tagType.tag_type_id]" :label="tagType.tag_type_name">
            <ion-select-option v-for="option in tagType.tags" :key="option.tag_id" :value="option.tag_id">
              {{ option.tag_name }}
            </ion-select-option>
          </ion-select>
        </div>
        ...
        <div class="grglia-selected" v-if="isGrigliaSelected">
          <div class="input-container">
            ...
            <ion-input class="input-box" v-model="height" placeholder="Altezza..."></ion-input>
          </div>
          <div class="input-container">
            <ion-label>Larghezza:</ion-label>
            <ion-input class="input-box" v-model="width" placeholder="Larghezza..."></ion-input>
          </div>
          <div class="input-container">
            <ion-label>Profondità:</ion-label>
            <ion-input class="input-box" v-model="depth" placeholder="Profondità..."></ion-input>
          </div>
        </div>

        <div class="input-container">
          <ion-label> Civico/Ubicazione:</ion-label>
          <ion-input class="input-box" v-model="address" placeholder="Inserisci numero civico / ubicazione"></ion-input>
        </div>

        <div class="input-container">
          <ion-label>Note:</ion-label>
          <ion-textarea class="input-box" v-model="notes" placeholder="Inserisci le tue note qui"></ion-textarea>
        </div>
...
<script setup lang="ts">
  import { IonPage, IonContent, IonIcon, IonButton, IonSelect, IonSelectOption, IonLabel, IonInput, IonTextarea, IonAlert } from '@ionic/vue';
