  ...
  <ion-page>
    <ion-content>
      ...
      <div class="sincro-caditoie">
          <h5>
              Caditoie da sincronizzare: {{ caditoieCount }}
          </h5>
      </div>
...
import { countItemsInDB, getItemsFromDB, deleteItemFromDB } from '@/services/db_items.js';
import { getUnsynchronizedStreetsFromDB, saveStreetsToDB } from '@/services/db_streets.js';
