...
<script lang="ts">
  ...
  export default defineComponent({
    props: {
      items: {
        type: Array as () => Item[], // specifica il tipo dell'array come Item[]
        default: () => [] as Item[], // assegna un array vuoto come valore predefinito
      },
      selectedItems: {
        type: Array as () => string[], // specifica il tipo dell'array come string[]
        default: () => [] as string[], // assegna un array vuoto come valore predefinito
      },
      title: {
        type: String,
